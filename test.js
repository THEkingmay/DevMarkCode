...
async function testConnection() {
  ...
  try {
    ...
    if (error) {
      ...
      console.log('---');
      console.log(
        'Hint: ตรวจสอบว่า SUPABASE_KEY ถูกต้อง และตาราง "Members" (หรือตารางที่เมใส่) มีอยู่จริง และเปิด RLS (Row Level Security) ถูกต้องหรือไม่'
      );
      return;
    }
    ...
    console.log('---');
    console.log(
      'Hint: ตรวจสอบว่า SUPABASE_URL ถูกต้องเป๊ะๆ และอินเทอร์เน็ต/Firewall ไม่ได้บล็อก'
    );
  }
}
